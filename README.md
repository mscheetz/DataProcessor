...
Extract, clean, and query financial data from PDF and CSV files.
...
Places files in `data/` (PDF, CSV). Outputs extracted results and queries to stdout.
...
src/
  ...
  extract.py  — PDF/CSV parsing + numeric column normalization
